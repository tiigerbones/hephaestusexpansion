...
public class HephExItemRegistry {
    ...
    static {
        HephExItemRegistry.katana = HephExItemRegistry.ITEMS.register("katana", () ->  new ModifiableSwordItem(HephExItemRegistry.TOOL, ToolDefinitions.KATANA, TinkerTabs.TAB_TOOLS));
